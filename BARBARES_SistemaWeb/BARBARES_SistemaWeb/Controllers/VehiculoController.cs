...
namespace BARBARES_SistemaWeb.Controllers
{
    public class VehiculoController : Controller
    {
        ...
        public ActionResult combo_Marca()
        {
            //Declaraciones Generales para los request
            ...
            webrequest = (HttpWebRequest)WebRequest.Create(Constantes.Combo_Marca);
            webrequest.Method = Constantes.PostMethod;
            webrequest.ContentType = Constantes.ContentType;
            webrequest.ContentLength = data.Length;
        ...
        public ActionResult combo_Modelo(int id)
        {
            //Declaraciones Generales para los request
            ...
            webrequest = (HttpWebRequest)WebRequest.Create(Constantes.Combo_Modelo);
            webrequest.Method = Constantes.PostMethod;
            webrequest.ContentType = Constantes.ContentType;
            webrequest.ContentLength = data.Length;
