...
namespace BARBARES_SistemaWeb.Controllers
{
    public class PromocionController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            webrequest = (HttpWebRequest)WebRequest.Create(Constantes.SelectAll_Promocion);
        ...
        [HttpPost]
        public ActionResult List(string nombre, string desde, string hasta, int min = 0, int max = 0, bool semana = false)
        {
            //Declaraciones Generales para los request
            ...
            Search.Promocion prd = new Search.Promocion()
            {
                Nombre = nombre,
                Minimo = min,
                Maximo = max,
            ...
            Debug.WriteLine(JsonSerializer.search_Promocion(prd));

            webrequest = (HttpWebRequest)WebRequest.Create(Constantes.Search_Promocion);
            webrequest.Method = Constantes.PostMethod;
            webrequest.ContentType = Constantes.ContentType;
            webrequest.ContentLength = data.Length;
